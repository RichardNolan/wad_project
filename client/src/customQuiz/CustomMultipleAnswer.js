			...
			<div className="row">
				<div className="card col s10 offset-s1">
					...
					<div className="input-field">
						...
						<input type="text" id="ans_correct" style={{background:'#D6F6ED'}} onChange={answerCorrectHandler}/>
			...
			<div className="row">
				<div className="card col s10 offset-s1">
					...
					<div className="input-field">
						...
						<input type="text" style={{background:'#F9D9D4'}} id="ans_incorrect1" onChange={(e)=>answerIncorrectHandler(e,0)}/>
						<label htmlFor="ans_incorrect1">write a possible answer here</label>
					</div>
					<div className="input-field">
						<i className="material-icons prefix">clear</i>
						<input type="text" style={{background:'#F9D9D4'}} id="ans_incorrect2" onChange={(e)=>answerIncorrectHandler(e,1)}/>
						<label htmlFor="ans_incorrect2">write a possible answer here</label>
					</div>
					<div className="input-field">
						<i className="material-icons prefix">clear</i>
						<input type="text" style={{background:'#F9D9D4'}} id="ans_incorrect3" onChange={(e)=>answerIncorrectHandler(e,2)}/>
